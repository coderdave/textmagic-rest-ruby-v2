...
# Unit tests for TextmagicRestClient::FavoriteContact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TextmagicRestClient::FavoriteContact do
  let(:instance) { TextmagicRestClient::FavoriteContact.new }

  describe 'test an instance of FavoriteContact' do
    it 'should create an instance of FavoriteContact' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TextmagicRestClient::FavoriteContact)
    end
  end
