...
# Unit tests for TextmagicRestClient::SenderId
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TextmagicRestClient::SenderId do
  let(:instance) { TextmagicRestClient::SenderId.new }

  describe 'test an instance of SenderId' do
    it 'should create an instance of SenderId' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TextmagicRestClient::SenderId)
    end
  end
