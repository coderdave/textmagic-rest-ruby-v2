...
# Unit tests for TextmagicRestClient::Timezone
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TextmagicRestClient::Timezone do
  let(:instance) { TextmagicRestClient::Timezone.new }

  describe 'test an instance of Timezone' do
    it 'should create an instance of Timezone' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TextmagicRestClient::Timezone)
    end
  end
