  ...
  class FavoriteContact
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TextmagicRestClient::FavoriteContact` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TextmagicRestClient::FavoriteContact`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'primary_label')
        self.primary_label = attributes[:'primary_label']
      else
        self.primary_label = nil
      end

      if attributes.key?(:'secondary_label')
        self.secondary_label = attributes[:'secondary_label']
      else
        self.secondary_label = nil
      end

      if attributes.key?(:'tertiary_label')
        self.tertiary_label = attributes[:'tertiary_label']
      else
        self.tertiary_label = nil
      end
